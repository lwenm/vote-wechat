      ...
      success: function success(res) {
        ...
        if (IMG_RATIO >= 1) {
          _this.setData({
            ...
            cutT: 0,
            cutR: 0,
            cutB: SCREEN_WIDTH / IMG_RATIO > 300 ? SCREEN_WIDTH / IMG_RATIO - 300 : 0,
            // 图片缩放值
          ...
          _this.setData({
            ...
            cutT: 0,
            cutB: Math.ceil(SCREEN_WIDTH - 300 * IMG_RATIO),
